...
public:
    ...
    void setupUi(QDialog *DendyDebugger)
    {
        ...
        buttonBox = new QDialogButtonBox(DendyDebugger);
        buttonBox->setObjectName(QStringLiteral("buttonBox"));
        buttonBox->setGeometry(QRect(10, 440, 461, 32));
    ...
    void retranslateUi(QDialog *DendyDebugger)
    {
        ...
        pcValue->setText(QApplication::translate("DendyDebugger", "4C2F", 0));
